...
// Only for 2D
function ray_seg_intersection(point_a, vec_a, start_b, end_b) {
...
// Only for 2D
function seg_intersection(start_a, end_a, start_b, end_b) {
...
function point_to_line_point(point, origin, dir) {
...
function point_to_seg_point(point, start, end) {
...
function point_to_seg_dist(point, start, end) {
